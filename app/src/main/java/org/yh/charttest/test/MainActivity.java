...
import org.yh.charttest.LineChartActivity1;
import org.yh.charttest.R;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        objects.add(new ContentItem("Line Chart", "一个简单的演示Line Chart."));
        ...
        objects.add(new ContentItem("Pie Chart with value lines", "A simple demonstration of the " +
                "pie chart with polyline notes."));
        ...
        objects.add(new ContentItem(
                ...
                "Demonstration of charts inside ViewPager Fragments. In this example the focus " +
                        "was on the design and look and feel of the chart."));
        objects.add(new ContentItem(
        ...
        objects.add(new ContentItem(
                "Realtime Chart",
                "This chart is fed with new data in realtime. It also restrains the view on the " +
                        "x-axis."));
        objects.add(new ContentItem(
                "Dynamical data adding",
                "This Activity demonstrates dynamical adding of Entries and DataSets (real time " +
                        "graph)."));
        objects.add(new ContentItem(
        ...
        objects.add(new ContentItem(
                ...
                "This demonstrates how to create a BarChart with positive and negative values in " +
                        "different colors."));
        ...
        ContentItem time = new ContentItem(
                "Time Chart",
                "Simple demonstration of a time-chart. This chart draws one line entry per hour " +
                        "originating from the current time in milliseconds.");
        time.isNew = true;
        objects.add(time);
        objects.add(new ContentItem(
                "Filled LineChart",
